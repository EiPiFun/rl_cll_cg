...
if __name__=='__main__':
    ...
    coarse_grained_cellulose_computation_class.generate_in_file(65.00,83.63,113.95,30.00,37.57,29.56,26.43,25.16,21.72,0.20,0.18,0.20,1.4,6.0,1.4,6.0,0.8,5.1,0.8,4.1,0.8,4.0,0.8,5.1,0.8,3.7,0.8,5.1)
