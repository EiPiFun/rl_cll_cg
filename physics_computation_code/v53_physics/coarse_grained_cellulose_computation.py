...
if __name__=='__main__':
    ...
    coarse_grained_cellulose_computation_class.generate_in_file(62.00,51.00,136.39,30.00,14.96,25.89,17.65,20.77,10.82,0.25,0.22,0.23,1.4,6.1,1.4,5.9,0.8,5.1,0.8,3.9,0.8,4.0,0.8,5.1,0.8,3.7,0.8,5.1)
