...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (6.2)) # 6.2*1.0
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (0.3*action[0]+1.5))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (6.2)) # 6.2*1.0
            temp_pc_1_1_1 = float(coefficient_precision_format % (0.5*action[1]+1.0))
            temp_pc_1_1_2 = float(coefficient_precision_format % (4.717)) # 5.3*0.89
            temp_pc_1_2_1 = float(coefficient_precision_format % (0.5*action[2]+1.0))
            temp_pc_1_2_2 = float(coefficient_precision_format % (4.272)) # 4.8*0.89
            temp_pc_1_3_1 = float(coefficient_precision_format % (0.5*action[3]+1.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (4.183)) # 4.7*0.89
            temp_pc_2_2_1 = float(coefficient_precision_format % (0.5*action[4]+1.0))
            temp_pc_2_2_2 = float(coefficient_precision_format % (4.005)) # 4.5*0.89
            temp_pc_2_3_1 = float(coefficient_precision_format % (0.5*action[5]+1.0))
            temp_pc_2_3_2 = float(coefficient_precision_format % (3.560)) # 4.0*0.89
            temp_pc_3_3_1 = float(coefficient_precision_format % (0.5*action[6]+1.0))
            temp_pc_3_3_2 = float(coefficient_precision_format % (3.916)) # 4.4*0.89
