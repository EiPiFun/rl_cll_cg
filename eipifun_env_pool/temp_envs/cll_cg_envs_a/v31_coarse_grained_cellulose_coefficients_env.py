...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_1_1 = float(coefficient_precision_format % (0.10*action[2]+1.00))
            temp_pc_1_1_2 = float(coefficient_precision_format % (0.051*action[3]+5.1+0.051))
            temp_pc_1_2_1 = float(coefficient_precision_format % (0.10*action[2]+1.00))
            temp_pc_1_2_2 = float(coefficient_precision_format % (0.042*action[3]+4.2+0.042))
            temp_pc_1_3_1 = float(coefficient_precision_format % (0.10*action[2]+1.00))
            temp_pc_1_3_2 = float(coefficient_precision_format % (0.041*action[3]+4.1+0.041))
            temp_pc_2_2_1 = float(coefficient_precision_format % (0.10*action[2]+1.00))
            temp_pc_2_2_2 = float(coefficient_precision_format % (0.051*action[3]+5.1+0.051))
            temp_pc_2_3_1 = float(coefficient_precision_format % (0.05*action[4]+0.55))
            temp_pc_2_3_2 = float(coefficient_precision_format % (0.02*action[5]+4.05+0.02))
            temp_pc_3_3_1 = float(coefficient_precision_format % (0.10*action[2]+1.00))
            temp_pc_3_3_2 = float(coefficient_precision_format % (0.051*action[3]+5.1+0.051))
