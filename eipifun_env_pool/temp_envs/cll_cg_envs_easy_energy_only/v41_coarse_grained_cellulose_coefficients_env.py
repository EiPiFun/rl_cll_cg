...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = gym.spaces.Box(
            (-1.0*numpy.ones((7),dtype=numpy.float32)),
            (+1.0*numpy.ones((7),dtype=numpy.float32)),
        )
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_2_1_hb = float(coefficient_precision_format % (0.3*action[0]+1.5))
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (6.0)) # 6.0
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (0.3*action[0]+1.5))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (6.0)) # 6.0
            temp_pc_1_1_1 = float(coefficient_precision_format % (0.5*action[1]+1.0))
            temp_pc_1_1_2 = float(coefficient_precision_format % (5.1))
            temp_pc_1_2_1 = float(coefficient_precision_format % (0.5*action[2]+1.0))
            temp_pc_1_2_2 = float(coefficient_precision_format % (4.2)) # 4.2
            temp_pc_1_3_1 = float(coefficient_precision_format % (0.5*action[3]+1.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (4.1)) # 4.1
            temp_pc_2_2_1 = float(coefficient_precision_format % (0.5*action[4]+1.0))
            temp_pc_2_2_2 = float(coefficient_precision_format % (5.1))
            temp_pc_2_3_1 = float(coefficient_precision_format % (0.2*action[5]+0.6))
            temp_pc_2_3_2 = float(coefficient_precision_format % (4.05)) # 3.7
            temp_pc_3_3_1 = float(coefficient_precision_format % (0.5*action[6]+1.0))
            temp_pc_3_3_2 = float(coefficient_precision_format % (5.1))
