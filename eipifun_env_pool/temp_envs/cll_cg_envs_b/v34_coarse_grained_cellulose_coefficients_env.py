...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = gym.spaces.Box(
            (-1.0*numpy.ones((6),dtype=numpy.float32)),
            (+1.0*numpy.ones((6),dtype=numpy.float32)),
        )
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_bc_1 =  64.06 #  65.00
            temp_bc_2 =  82.42 #  83.63
            temp_bc_3 = 112.30 # 113.95
            temp_ac_1 =  30.97 #  30.00
            temp_ac_2 =  38.79 #  37.57
            temp_ac_3 =  30.52 #  29.56
            temp_ac_4 =  27.28 #  26.43
            temp_ac_5 =  25.97 #  25.16
            temp_ac_6 =  22.42 #  21.72
            temp_ic_1 = 0.1702 #   0.20
            temp_ic_2 = 0.1555 #   0.17
            temp_ic_3 = 0.1698 #   0.19
            temp_pc_1_2_1_hb = float(coefficient_precision_format % (0.10*action[0]+1.50))
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (0.3*action[1]+6.0+0.3))
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (0.10*action[0]+1.50))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (0.3*action[1]+6.0+0.3))
            temp_pc_1_1_1 = float(coefficient_precision_format % (0.50*action[2]+1.00))
            temp_pc_1_1_2 = float(coefficient_precision_format % (0.2805*action[3]+5.1+0.2805))
            temp_pc_1_2_1 = float(coefficient_precision_format % (0.50*action[2]+1.00))
            temp_pc_1_2_2 = float(coefficient_precision_format % (0.2310*action[3]+4.2+0.2310))
            temp_pc_1_3_1 = float(coefficient_precision_format % (0.50*action[2]+1.00))
            temp_pc_1_3_2 = float(coefficient_precision_format % (0.2255*action[3]+4.1+0.2255))
            temp_pc_2_2_1 = float(coefficient_precision_format % (0.50*action[2]+1.00))
            temp_pc_2_2_2 = float(coefficient_precision_format % (0.2805*action[3]+5.1+0.2805))
            temp_pc_2_3_1 = float(coefficient_precision_format % (0.50*action[4]+1.00))
            temp_pc_2_3_2 = float(coefficient_precision_format % (0.2035*action[5]+3.7+0.2035))
            temp_pc_3_3_1 = float(coefficient_precision_format % (0.50*action[2]+1.00))
            temp_pc_3_3_2 = float(coefficient_precision_format % (0.2805*action[3]+5.1+0.2805))
        ...
        temp_coarse_grained_cellulose_computation_class.generate_in_file(temp_bc_1,temp_bc_2,temp_bc_3,temp_ac_1,temp_ac_2,temp_ac_3,temp_ac_4,temp_ac_5,temp_ac_6,temp_ic_1,temp_ic_2,temp_ic_3,temp_pc_1_2_1_hb,temp_pc_1_2_2_hb,temp_pc_1_3_1_hb,temp_pc_1_3_2_hb,temp_pc_1_1_1,temp_pc_1_1_2,temp_pc_1_2_1,temp_pc_1_2_2,temp_pc_1_3_1,temp_pc_1_3_2,temp_pc_2_2_1,temp_pc_2_2_2,temp_pc_2_3_1,temp_pc_2_3_2,temp_pc_3_3_1,temp_pc_3_3_2)
