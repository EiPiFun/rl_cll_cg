...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (0.1*action[1]+6.0))
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (0.3*action[0]+1.5))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (0.1*action[1]+6.0))
            temp_pc_1_1_1 = float(coefficient_precision_format % (0.5*action[2]+1.0))
            temp_pc_1_1_2 = float(coefficient_precision_format % (0.1*action[3]+5.1))
            temp_pc_1_2_1 = float(coefficient_precision_format % (0.5*action[4]+1.0))
            temp_pc_1_2_2 = float(coefficient_precision_format % (0.1*action[5]+4.2))
            temp_pc_1_3_1 = float(coefficient_precision_format % (0.5*action[6]+1.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (0.1*action[7]+4.1))
            temp_pc_2_2_1 = float(coefficient_precision_format % (0.5*action[8]+1.0))
            temp_pc_2_2_2 = float(coefficient_precision_format % (0.1*action[3]+5.1))
            temp_pc_2_3_1 = float(coefficient_precision_format % (0.2*action[9]+0.5))
            temp_pc_2_3_2 = float(coefficient_precision_format % (0.4*action[10]+4.1))
            temp_pc_3_3_1 = float(coefficient_precision_format % (0.5*action[11]+1.0))
            temp_pc_3_3_2 = float(coefficient_precision_format % (0.1*action[3]+5.1))
