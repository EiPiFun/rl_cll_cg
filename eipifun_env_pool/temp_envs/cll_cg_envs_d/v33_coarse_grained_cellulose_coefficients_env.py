...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_2_2 = float(coefficient_precision_format % (0.462*action[5]+4.2))
            temp_pc_1_3_1 = float(coefficient_precision_format % (0.50*action[6]+1.00))
            temp_pc_1_3_2 = float(coefficient_precision_format % (0.451*action[7]+4.1))
            temp_pc_2_2_1 = float(coefficient_precision_format % (0.50*action[8]+1.00))
            temp_pc_2_2_2 = float(coefficient_precision_format % (0.561*action[3]+5.1))
            temp_pc_2_3_1 = float(coefficient_precision_format % (0.50*action[9]+1.00))
            temp_pc_2_3_2 = float(coefficient_precision_format % (0.407*action[10]+3.7))
            temp_pc_3_3_1 = float(coefficient_precision_format % (0.50*action[11]+1.00))
