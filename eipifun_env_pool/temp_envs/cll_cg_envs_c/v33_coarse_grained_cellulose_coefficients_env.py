...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = gym.spaces.Box(
            (-1.0*numpy.ones((10),dtype=numpy.float32)),
            (+1.0*numpy.ones((10),dtype=numpy.float32)),
        )
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (0.3*action[1]+6.0))
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (0.10*action[0]+1.50))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (0.3*action[1]+6.0))
            temp_pc_1_1_1 = float(coefficient_precision_format % (0.50*action[2]+1.00))
            temp_pc_1_1_2 = float(coefficient_precision_format % (0.561*action[3]+5.1))
            temp_pc_1_2_1 = float(coefficient_precision_format % (0.50*action[4]+1.00))
            temp_pc_1_2_2 = float(coefficient_precision_format % (0.462*action[3]+4.2))
            temp_pc_1_3_1 = float(coefficient_precision_format % (0.50*action[5]+1.00))
            temp_pc_1_3_2 = float(coefficient_precision_format % (0.451*action[3]+4.1))
            temp_pc_2_2_1 = float(coefficient_precision_format % (0.50*action[6]+1.00))
            temp_pc_2_2_2 = float(coefficient_precision_format % (0.561*action[3]+5.1))
            temp_pc_2_3_1 = float(coefficient_precision_format % (0.50*action[7]+1.00))
            temp_pc_2_3_2 = float(coefficient_precision_format % (0.2035*action[8]+3.7+0.2035))
            temp_pc_3_3_1 = float(coefficient_precision_format % (0.50*action[9]+1.00))
            temp_pc_3_3_2 = float(coefficient_precision_format % (0.561*action[3]+5.1))
