...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_bc_1 = 60.94 #  62.00
            temp_bc_2 = 50.13 #  51.00
            temp_bc_3 = 134.1 # 136.39
            temp_ac_1 = 43.18 #  30.00
            temp_ac_2 = 21.53 #  14.96
            temp_ac_3 = 37.27 #  25.89
            temp_ac_4 = 25.41 #  17.65
            temp_ac_5 = 29.89 #  20.77
            temp_ac_6 = 15.58 #  10.82
            temp_ic_1 = 0.1689 #  0.25
            temp_ic_2 = 0.1490 #  0.22
            temp_ic_3 = 0.1571 #  0.23
            temp_pc_1_2_1_hb = float(coefficient_precision_format % (2.0*action[0]+2.0))
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (1.525*action[1]+6.1))
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (2.0*action[0]+2.0))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (1.475*action[1]+5.9))
            ...
            temp_pc_1_2_2 = float(coefficient_precision_format % (1.0*action[5]+3.9))
            temp_pc_1_3_1 = float(coefficient_precision_format % (2.0*action[6]+2.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (1.0*action[7]+4.0))
