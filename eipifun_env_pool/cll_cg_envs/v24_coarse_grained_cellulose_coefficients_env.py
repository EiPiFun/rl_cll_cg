...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_bc_1 = 58.92 #  60.00
            temp_bc_2 = 44.20 #  45.01
            temp_bc_3 = 95.33 #  97.07
            temp_ac_1 = 35.26 #  25.00
            temp_ac_2 = 27.41 #  19.44
            temp_ac_3 = 40.02 #  28.38
            temp_ac_4 = 15.37 #  10.90
            temp_ac_5 = 18.27 #  12.96
            temp_ac_6 = 17.01 #  12.06
            temp_ic_1 = 0.1012 #  0.16
            temp_ic_2 = 0.1335 #  0.21
            temp_ic_3 = 0.1098 #  0.18
            temp_pc_1_2_1_hb = float(coefficient_precision_format % (2.0*action[0]+2.0))
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (1.6*action[1]+6.4))
            ...
            temp_pc_1_2_2 = float(coefficient_precision_format % (1.1*action[5]+4.4))
            temp_pc_1_3_1 = float(coefficient_precision_format % (2.0*action[6]+2.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (1.0*action[7]+3.9))
            ...
            temp_pc_2_3_2 = float(coefficient_precision_format % (1.0*action[10]+3.8))
