...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (3.05*action[1]+6.1))
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (8.0*action[0]+8.0))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (2.95*action[1]+5.9))
            ...
            temp_pc_1_2_2 = float(coefficient_precision_format % (2.0*action[5]+3.9))
            temp_pc_1_3_1 = float(coefficient_precision_format % (4.0*action[6]+4.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (2.0*action[7]+4.0))
