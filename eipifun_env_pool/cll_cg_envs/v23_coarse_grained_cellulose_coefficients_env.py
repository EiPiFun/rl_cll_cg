...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (3.2*action[1]+6.4))
            ...
            temp_pc_1_2_2 = float(coefficient_precision_format % (2.2*action[5]+4.4))
            temp_pc_1_3_1 = float(coefficient_precision_format % (4.0*action[6]+4.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (2.0*action[7]+3.9))
            ...
            temp_pc_2_3_2 = float(coefficient_precision_format % (1.9*action[10]+3.8))
