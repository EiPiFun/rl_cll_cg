...
coarse_grained_cellulose_physics_computation_5_code_inputs_directory = coarse_grained_cellulose_computation_code_directory+'physics_computation_5/inputs/'
coarse_grained_cellulose_physics_computation_6_code_inputs_directory = coarse_grained_cellulose_computation_code_directory+'physics_computation_6/inputs/'
coarse_grained_cellulose_physics_computation_7_code_inputs_directory = coarse_grained_cellulose_computation_code_directory+'physics_computation_7/inputs/'
...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = gym.spaces.Box(
            (-1.0*numpy.ones((12),dtype=numpy.float32)),
            (+1.0*numpy.ones((12),dtype=numpy.float32)),
        )
        ...
        self.coarse_grained_cellulose_coefficients_pool_header = 'step_count,bc_1,bc_2,bc_2_3,bc_2_4,bc_3,ac_1,ac_2,ac_2_3,ac_2_4,ac_3,ac_4,ac_4_3,ac_4_4,ac_5,ac_6,ac_6_3,ac_6_4,ic_1,ic_2,ic_3,pc_1_2_1_hb,pc_1_2_2_hb,pc_1_3_1_hb,pc_1_3_2_hb,pc_1_1_1,pc_1_1_2,pc_1_2_1,pc_1_2_2,pc_1_3_1,pc_1_3_2,pc_2_2_1,pc_2_2_2,pc_2_3_1,pc_2_3_2,pc_3_3_1,pc_3_3_2'
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_bc_1 =  64.62 #  65.00
            temp_bc_2 = 113.30 # 113.95
            temp_bc_2_3 = -1022.00 # -1027.78
            temp_bc_2_4 =  2313.00 #  2326.55
            temp_bc_3 =  151.80 # 152.66
            temp_ac_1 =   32.60 #  30.00
            temp_ac_2 =   90.83 #  83.59
            temp_ac_2_3 = -1031.00 #  -948.45
            temp_ac_2_4 =  2895.00 #  2664.18
            temp_ac_3 =  108.30 #  99.71
            temp_ac_4 =   56.26 #  51.77
            temp_ac_4_3 =  -603.80 #  -555.66
            temp_ac_4_4 =  1699.00 #  1563.45
            temp_ac_5 =   67.73 #  62.33
            temp_ac_6 =  121.90 # 112.18
            temp_ac_6_3 = -1558.00 # -1433.94
            temp_ac_6_4 =  4597.00 #  4230.00
            temp_ic_1 = 0.1847 #  0.20
            temp_ic_2 = 0.3632 #  0.39
            temp_ic_3 = 0.6597 #  0.71
            temp_pc_1_2_1_hb = float(coefficient_precision_format % (2.0*action[0]+2.0))
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (1.5*action[1]+6.0))
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (2.0*action[0]+2.0))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (1.5*action[1]+6.0))
            temp_pc_1_1_1 = float(coefficient_precision_format % (2.0*action[2]+2.0))
            temp_pc_1_1_2 = float(coefficient_precision_format % (1.3*action[3]+5.1))
            temp_pc_1_2_1 = float(coefficient_precision_format % (2.0*action[4]+2.0))
            temp_pc_1_2_2 = float(coefficient_precision_format % (1.1*action[5]+4.2))
            temp_pc_1_3_1 = float(coefficient_precision_format % (2.0*action[6]+2.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (1.0*action[7]+4.1))
            temp_pc_2_2_1 = float(coefficient_precision_format % (2.0*action[8]+2.0))
            temp_pc_2_2_2 = float(coefficient_precision_format % (1.3*action[3]+5.1))
            temp_pc_2_3_1 = float(coefficient_precision_format % (2.0*action[9]+2.0))
            temp_pc_2_3_2 = float(coefficient_precision_format % (0.9*action[10]+3.7))
            temp_pc_3_3_1 = float(coefficient_precision_format % (2.0*action[11]+2.0))
            temp_pc_3_3_2 = float(coefficient_precision_format % (1.3*action[3]+5.1))

        temp_coefficients = (self.step_count,temp_bc_1,temp_bc_2,temp_bc_2_3,temp_bc_2_4,temp_bc_3,temp_ac_1,temp_ac_2,temp_ac_2_3,temp_ac_2_4,temp_ac_3,temp_ac_4,temp_ac_4_3,temp_ac_4_4,temp_ac_5,temp_ac_6,temp_ac_6_3,temp_ac_6_4,temp_ic_1,temp_ic_2,temp_ic_3,temp_pc_1_2_1_hb,temp_pc_1_2_2_hb,temp_pc_1_3_1_hb,temp_pc_1_3_2_hb,temp_pc_1_1_1,temp_pc_1_1_2,temp_pc_1_2_1,temp_pc_1_2_2,temp_pc_1_3_1,temp_pc_1_3_2,temp_pc_2_2_1,temp_pc_2_2_2,temp_pc_2_3_1,temp_pc_2_3_2,temp_pc_3_3_1,temp_pc_3_3_2)
        ...
        temp_coarse_grained_cellulose_physics_computation_5_inputs_directory = temp_coarse_grained_cellulose_computation_working_directory+'physics_computation_5/inputs/'
        temp_coarse_grained_cellulose_physics_computation_5_results_directory = temp_coarse_grained_cellulose_computation_working_directory+'physics_computation_5/results/'
        temp_coarse_grained_cellulose_physics_computation_6_inputs_directory = temp_coarse_grained_cellulose_computation_working_directory+'physics_computation_6/inputs/'
        temp_coarse_grained_cellulose_physics_computation_6_results_directory = temp_coarse_grained_cellulose_computation_working_directory+'physics_computation_6/results/'
        temp_coarse_grained_cellulose_physics_computation_7_inputs_directory = temp_coarse_grained_cellulose_computation_working_directory+'physics_computation_7/inputs/'
        temp_coarse_grained_cellulose_physics_computation_7_results_directory = temp_coarse_grained_cellulose_computation_working_directory+'physics_computation_7/results/'

        for temp_directory in (temp_coarse_grained_cellulose_computation_working_directory,temp_coarse_grained_cellulose_physics_computation_1_inputs_directory,temp_coarse_grained_cellulose_physics_computation_1_results_directory,temp_coarse_grained_cellulose_physics_computation_2_inputs_directory,temp_coarse_grained_cellulose_physics_computation_2_results_directory,temp_coarse_grained_cellulose_physics_computation_3_inputs_directory,temp_coarse_grained_cellulose_physics_computation_3_results_directory,temp_coarse_grained_cellulose_physics_computation_4_inputs_directory,temp_coarse_grained_cellulose_physics_computation_4_results_directory,temp_coarse_grained_cellulose_physics_computation_5_inputs_directory,temp_coarse_grained_cellulose_physics_computation_5_results_directory,temp_coarse_grained_cellulose_physics_computation_6_inputs_directory,temp_coarse_grained_cellulose_physics_computation_6_results_directory,temp_coarse_grained_cellulose_physics_computation_7_inputs_directory,temp_coarse_grained_cellulose_physics_computation_7_results_directory):
        ...
        for file_name in ('in_file_constant_head.txt','in_file_constant_tail.txt','coarse_grained_cellulose.data','compute_average_direction_angle_from_lammps_dump'):
            shutil.copyfile(coarse_grained_cellulose_physics_computation_5_code_inputs_directory+file_name,temp_coarse_grained_cellulose_physics_computation_5_inputs_directory+file_name)
        
        for file_name in ('in_file_constant_head.txt','in_file_constant_tail.txt','coarse_grained_cellulose.data','compute_average_direction_angle_from_lammps_dump'):
            shutil.copyfile(coarse_grained_cellulose_physics_computation_6_code_inputs_directory+file_name,temp_coarse_grained_cellulose_physics_computation_6_inputs_directory+file_name)
        
        for file_name in ('in_file_constant_head.txt','in_file_constant_tail.txt','coarse_grained_cellulose.data','compute_average_direction_angle_from_lammps_dump'):
            shutil.copyfile(coarse_grained_cellulose_physics_computation_7_code_inputs_directory+file_name,temp_coarse_grained_cellulose_physics_computation_7_inputs_directory+file_name)
        ...
        temp_coarse_grained_cellulose_computation_class.generate_in_file(temp_bc_1,temp_bc_2,temp_bc_2_3,temp_bc_2_4,temp_bc_3,temp_ac_1,temp_ac_2,temp_ac_2_3,temp_ac_2_4,temp_ac_3,temp_ac_4,temp_ac_4_3,temp_ac_4_4,temp_ac_5,temp_ac_6,temp_ac_6_3,temp_ac_6_4,temp_ic_1,temp_ic_2,temp_ic_3,temp_pc_1_2_1_hb,temp_pc_1_2_2_hb,temp_pc_1_3_1_hb,temp_pc_1_3_2_hb,temp_pc_1_1_1,temp_pc_1_1_2,temp_pc_1_2_1,temp_pc_1_2_2,temp_pc_1_3_1,temp_pc_1_3_2,temp_pc_2_2_1,temp_pc_2_2_2,temp_pc_2_3_1,temp_pc_2_3_2,temp_pc_3_3_1,temp_pc_3_3_2)
        ...
        temp_coarse_grained_cellulose_computation_5_queue = multiprocessing.Queue()
        temp_coarse_grained_cellulose_computation_6_queue = multiprocessing.Queue()
        temp_coarse_grained_cellulose_computation_7_queue = multiprocessing.Queue()
        temp_coarse_grained_cellulose_computation_queue_array = (temp_coarse_grained_cellulose_computation_1_queue,temp_coarse_grained_cellulose_computation_2_queue,temp_coarse_grained_cellulose_computation_3_queue,temp_coarse_grained_cellulose_computation_4_queue,temp_coarse_grained_cellulose_computation_5_queue,temp_coarse_grained_cellulose_computation_6_queue,temp_coarse_grained_cellulose_computation_7_queue)
        ...
        temp_coarse_grained_cellulose_computation_5_process = multiprocessing.Process(target=temp_coarse_grained_cellulose_computation_class.physics_computation_5,daemon=True,args=(temp_coarse_grained_cellulose_computation_5_queue,))
        temp_coarse_grained_cellulose_computation_6_process = multiprocessing.Process(target=temp_coarse_grained_cellulose_computation_class.physics_computation_6,daemon=True,args=(temp_coarse_grained_cellulose_computation_6_queue,))
        temp_coarse_grained_cellulose_computation_7_process = multiprocessing.Process(target=temp_coarse_grained_cellulose_computation_class.physics_computation_7,daemon=True,args=(temp_coarse_grained_cellulose_computation_7_queue,))

        temp_coarse_grained_cellulose_computation_7_process.start()

        temp_coarse_grained_cellulose_computation_process_array = (temp_coarse_grained_cellulose_computation_1_process,temp_coarse_grained_cellulose_computation_2_process,temp_coarse_grained_cellulose_computation_3_process,temp_coarse_grained_cellulose_computation_4_process)
        ...
        temp_coarse_grained_cellulose_computation_process_array = (temp_coarse_grained_cellulose_computation_5_process,temp_coarse_grained_cellulose_computation_6_process)
        for process in temp_coarse_grained_cellulose_computation_process_array:
            process.start()
        for process in temp_coarse_grained_cellulose_computation_process_array:
            process.join(timeout=coarse_grained_cellulose_computation_timeout)
    
        temp_coarse_grained_cellulose_computation_7_process.join(timeout=coarse_grained_cellulose_computation_timeout)

        temp_coarse_grained_cellulose_computation_return_array = [False,False,False,False,False,False,False]
        ...
        if temp_coarse_grained_cellulose_computation_return == True:
            ...
            temp_system_stable_enough_switch = default_system_stable_enough_switch
            temp_fracture_average_direction_angle_match_degree = default_fracture_average_direction_angle_match_degree
            temp_fracture_rotation_angle_match_degree = default_fracture_rotation_angle_match_degree
            temp_max_stress_match_degree = default_max_stress_match_degree
            temp_max_strain_energy_match_degree = default_max_strain_energy_match_degree
            temp_equivalent_strain_match_degree = default_equivalent_strain_match_degree

        temp_reward_value = 5.0*(temp_elastic_modulus_match_degree+temp_persistence_length_match_degree+temp_end_to_end_distance_match_degree+temp_system_stable_enough_switch+temp_fracture_average_direction_angle_match_degree+temp_fracture_rotation_angle_match_degree+14.0*min(temp_max_stress_match_degree,temp_max_strain_energy_match_degree)+temp_equivalent_strain_match_degree)
