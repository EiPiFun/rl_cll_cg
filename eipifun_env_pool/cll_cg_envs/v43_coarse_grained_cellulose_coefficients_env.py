...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_pc_1_2_1_hb = float(coefficient_precision_format % (8.0*action[0]+8.0))
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (3.0*action[1]+6.0))
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (8.0*action[0]+8.0))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (3.0*action[1]+6.0))
            temp_pc_1_1_1 = float(coefficient_precision_format % (4.0*action[2]+4.0))
            temp_pc_1_1_2 = float(coefficient_precision_format % (2.6*action[3]+5.1))
            temp_pc_1_2_1 = float(coefficient_precision_format % (4.0*action[4]+4.0))
            temp_pc_1_2_2 = float(coefficient_precision_format % (2.1*action[5]+4.2))
            temp_pc_1_3_1 = float(coefficient_precision_format % (4.0*action[6]+4.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (2.1*action[7]+4.1))
            temp_pc_2_2_1 = float(coefficient_precision_format % (4.0*action[8]+4.0))
            temp_pc_2_2_2 = float(coefficient_precision_format % (2.6*action[3]+5.1))
            temp_pc_2_3_1 = float(coefficient_precision_format % (4.0*action[9]+4.0))
            temp_pc_2_3_2 = float(coefficient_precision_format % (1.9*action[10]+3.7))
            temp_pc_3_3_1 = float(coefficient_precision_format % (4.0*action[11]+4.0))
            temp_pc_3_3_2 = float(coefficient_precision_format % (2.6*action[3]+5.1))
