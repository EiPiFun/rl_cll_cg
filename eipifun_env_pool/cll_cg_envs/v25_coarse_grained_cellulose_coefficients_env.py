...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_bc_2 = float(coefficient_precision_format % (0.7502*temp_bc_1))
            temp_bc_3 = float(coefficient_precision_format % (1.6179*temp_bc_1))
            temp_ac_1 = float(coefficient_precision_format % (10.0*action[1]+35.0))
            temp_ac_2 = float(coefficient_precision_format % (0.7774*temp_ac_1))
            temp_ac_3 = float(coefficient_precision_format % (1.1351*temp_ac_1))
            temp_ac_4 = float(coefficient_precision_format % (0.4358*temp_ac_1))
            temp_ac_5 = float(coefficient_precision_format % (0.5182*temp_ac_1))
            temp_ac_6 = float(coefficient_precision_format % (0.4824*temp_ac_1))
            temp_ic_1 = float(coefficient_precision_format % (0.35*action[2]+0.50))
            temp_ic_2 = float(coefficient_precision_format % (1.3188*temp_ic_1))
            temp_ic_3 = float(coefficient_precision_format % (1.0850*temp_ic_1))
            temp_pc_1_2_1_hb = float(coefficient_precision_format % (2.0*action[3]+2.0))
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (1.6*action[4]+6.4))
            ...
            temp_pc_1_2_2 = float(coefficient_precision_format % (1.1*action[8]+4.4))
            temp_pc_1_3_1 = float(coefficient_precision_format % (2.0*action[9]+2.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (1.0*action[10]+3.9))
            ...
            temp_pc_2_3_2 = float(coefficient_precision_format % (1.0*action[13]+3.8))
