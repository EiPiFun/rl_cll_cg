...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_bc_2 = float(coefficient_precision_format % (1.7531*temp_bc_1))
            temp_bc_2_3 = float(coefficient_precision_format % (-15.812*temp_bc_1))
            temp_bc_2_4 = float(coefficient_precision_format % (35.793*temp_bc_1))
            temp_bc_3 = float(coefficient_precision_format % (2.3486*temp_bc_1))
            temp_ac_1 = float(coefficient_precision_format % (5.0*action[1]+30.0))
            temp_ac_2 = float(coefficient_precision_format % (2.7862*temp_ac_1))
            temp_ac_2_3 = float(coefficient_precision_format % (-31.615*temp_ac_1))
            temp_ac_2_4 = float(coefficient_precision_format % (88.806*temp_ac_1))
            temp_ac_3 = float(coefficient_precision_format % (3.3236*temp_ac_1))
            temp_ac_4 = float(coefficient_precision_format % (1.7258*temp_ac_1))
            temp_ac_4_3 = float(coefficient_precision_format % (-18.522*temp_ac_1))
            temp_ac_4_4 = float(coefficient_precision_format % (52.115*temp_ac_1))
            temp_ac_5 = float(coefficient_precision_format % (2.0777*temp_ac_1))
            temp_ac_6 = float(coefficient_precision_format % (3.7393*temp_ac_1))
            temp_ac_6_3 = float(coefficient_precision_format % (-47.798*temp_ac_1))
            temp_ac_6_4 = float(coefficient_precision_format % (141.00*temp_ac_1))
            temp_ic_1 = float(coefficient_precision_format % (0.35*action[2]+0.50))
            temp_ic_2 = float(coefficient_precision_format % (1.9666*temp_ic_1))
            temp_ic_3 = float(coefficient_precision_format % (3.5715*temp_ic_1))
            temp_pc_1_2_1_hb = float(coefficient_precision_format % (2.0*action[3]+2.0))
            temp_pc_1_2_2_hb = float(coefficient_precision_format % (1.5*action[4]+6.0))
            temp_pc_1_3_1_hb = float(coefficient_precision_format % (2.0*action[3]+2.0))
            temp_pc_1_3_2_hb = float(coefficient_precision_format % (1.5*action[4]+6.0))
            ...
            temp_pc_1_2_2 = float(coefficient_precision_format % (1.1*action[8]+4.2))
            temp_pc_1_3_1 = float(coefficient_precision_format % (2.0*action[9]+2.0))
            temp_pc_1_3_2 = float(coefficient_precision_format % (1.0*action[10]+4.1))
