...
class CoarseGrainedCelluloseCoefficientsEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action is not None:
            ...
            temp_bc_1 = float(coefficient_precision_format % (200.0*action[0]+200.0))
            temp_bc_2 = 100.0
            temp_bc_2_3 = 100.0
            temp_bc_2_4 = 100.0
            temp_bc_3 = 100.0
            temp_ac_1 = float(coefficient_precision_format % (200.0*action[0]+200.0))
            temp_ac_2 = 100.0
            temp_ac_2_3 = 100.0
            temp_ac_2_4 = 100.0
            temp_ac_3 = 100.0
            ...
            temp_ac_6_3 = 100.0
            temp_ac_6_4 = 100.0
            temp_ic_1 = float(coefficient_precision_format % (200.0*action[0]+200.0))
            temp_ic_2 = 100.0
            temp_ic_3 = 100.0
